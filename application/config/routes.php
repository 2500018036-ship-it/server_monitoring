...
$route['ssh-config/install-agent/(:num)'] = 'ssh_config/install_agent/$1';
...
$route['settings/telegram-bot'] = 'telegram';
$route['settings/telegram-bot/connect'] = 'telegram/connect';
$route['settings/telegram-bot/get-chat-id'] = 'telegram/get_chat_id';
$route['settings/telegram-bot/select-chat'] = 'telegram/select_chat';
$route['settings/telegram-bot/test-message'] = 'telegram/test_message';
$route['settings/notification-settings'] = 'telegram/notifications';
$route['settings/notification-settings/update'] = 'telegram/update_notifications';
